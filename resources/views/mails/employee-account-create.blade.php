          ...
          <tr>
            <td valign="top" class="content" style="background:white;padding:20px 35px 10px 35px;">
              ...
              <p style="text-align: justify">
                Your account has been created on <a href="http://mudraeducation.org/employee">Gyandeep NGO</a>. Login
                ...
                <br>
                Click <a href="http://mudraeducation.org/employee">here</a> to login.
                <br>
                <br>
                <br>
