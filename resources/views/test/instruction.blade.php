            ...
            <div class="box">
              <div class="box-body pt-10">
                ...
                <div id="ins" class="instrucations">
                  <ul>
                    <li>
                      <div class="d-flex  align-items-center"><i class="fa fa-chevron-right mainrights mr-2 "
                          aria-hidden="true"></i>
                    ...
                    <li>
                      ...
                      </div> Multiple Choice Questions (MCQs)
                    </li>
                    <li>
                      <div class="d-flex  align-items-center"><i class="fa fa-chevron-right mainrights mr-2 "
                          aria-hidden="true"></i>
                        <strong>Navigation:</strong>
                      </div> Use the "Save" and "Next" buttons to move through the questions
                    </li>
                    ...
                    <li>
                      ...
                      </div> The exam will automatically submit once the timer reaches zero.
                    </li>
                    <li>
                      <div class="d-flex  align-items-center"><i class="fa fa-chevron-right mainrights mr-2 "
                          aria-hidden="true"></i>
                        <strong>Timer:</strong>
                      </div> The countdown timer is server-based and cannot be paused or adjusted.
                    </li>
                    <li>
                      <div class="d-flex  align-items-center"><i class="fa fa-chevron-right mainrights mr-2 "
                          aria-hidden="true"></i>
                        <strong>Submission:</strong>
                      </div> No manual submission is required. The system will auto-submit your responses when the time
                      ends.
                    </li>
                    <li>
                      <div class="d-flex  align-items-center"><i class="fa fa-chevron-right mainrights mr-2 "
                      ...
                      </div> You can mark any question for review and revisit it before final submission.
                    </li>
                    <li>
                      <div class="d-flex  align-items-center"><i class="fa fa-chevron-right mainrights mr-2 "
                          aria-hidden="true"></i>
                        <strong>Screen Monitoring:</strong>
                      </div> Your screen is under automatic recording for the duration of the exam.
                    </li>
                    <li>
                      <div class="d-flex  align-items-center"> <i class="fa fa-chevron-right mainrights mr-2 "
                          aria-hidden="true"></i>
                        <strong>Academic Integrity:</strong>
                      </div> Any form of cheating or malpractice will lead to disqualification.
                    </li>
              ...
              <div class="box-footer">
                <div class="pull-right">
                  <a href="{{ url('test/' . $exam->token . '/start-test') }}">
                    <button type="button" class="btn btn-primary">Next <i class="ti-arrow-right"></i></button>
                  </a>
                </div>
              </div>
            </div>
