            ...
            <div class="d-inline-block align-items-center">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Provider type</li>
                </ol>
              </nav>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input name="provider_type" type="text" class="form-control" placeholder="Provider Type"
                          value="{{ $ft == 'edit' ? $sd->provider_type : old('provider_type') }}">
          ...
          <div class="col-lg-12 col-md-12 col-12">
            <div class="box">
              <div class="box-header">
                <h4 class="box-title">Provider Type List</h4>
              </div>
              <div class="box-body">
                      ...
                      @foreach ($rows as $row)
                        <tr id="row{{ $row->id }}">
                          ...
                          <td>
                            ...
                            <a href="{{ url('admin/provider-type/update/' . $row->id) }}"
