...
@push('title')
  <title>Testimonials - Gyandeep NGO</title>
@endpush
                ...
                <div class="box-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2 col-sm-12">
                      <div class="form-group">
                        ...
                        <input name="rating" type="number" min="1" max="5" class="form-control"
                          placeholder="Rating" value="{{ $ft == 'edit' ? $sd->rating : old('rating') }}">
                        <span class="text-danger">
                          @error('rating')
                            {{ $message }}
                          @enderror
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <textarea class="form-control mb-2 mr-sm-2" id="review" name="review" placeholder="Enter review">{{ $ft == 'edit' ? $sd->review : old('review') }}</textarea>
                    </div>
                    <div class="col-md-4 col-sm-12">
                      <div class="form-group">
                        <label>Photo</label>
                      ...
                      @foreach ($rows as $row)
                        <tr id="row{{ $row->id }}">
                          ...
                          <td>
                            @if ($row->review != '')
                              <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                title="Click to view" data-target="#review<?php echo $row->id; ?>">
                                view
                              </button>
                              <div class="modal" id="review{{ $row->id }}" tabindex="-1" role="dialog"
                                aria-hidden="true">
                          ...
                          <td>
                            ...
                            <a href="{{ url('admin/testimonial/update/' . $row->id) }}"
