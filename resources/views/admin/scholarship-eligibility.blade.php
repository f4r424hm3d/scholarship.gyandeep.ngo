...
@push('title')
  <title>Scholarship Eligible Country</title>
@endpush
@section('main-section')
            ...
            <div class="d-inline-block align-items-center">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Scholarship Eligibility
                    ({{ $sch->name }})</li>
                </ol>
              </nav>
            </div>
                  ...
                  <div class="row">
                    <div class="col-md-3 col-sm-12">
                      <div class="form-group">
                        <label>Country</label>
                        <select name="country{{ $ft == 'edit' ? '' : '[]' }}" id="country" type="text"
                      ...
                      @foreach ($rows as $row)
                        ...
                        <tr id="row{{ $row->id }}">
                          ...
                          <td>
                            ...
                            <a href="{{ url('admin/scholarship/eligibility/' . $sch->id . '/update/' . $row->id) }}"
  ...
  <script>
    function DeleteAjax(id) {
      ...
      if (cd == true) {
        $.ajax({
          url: "{{ url('admin/scholarship/eligibility/delete') }}" + "/" + id,
