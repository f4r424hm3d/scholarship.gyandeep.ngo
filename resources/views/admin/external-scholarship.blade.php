...
@section('main-section')
            ...
            <div class="d-inline-block align-items-center">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">External Scholarship</li>
                </ol>
              </nav>
            </div>
          </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <select name="covers" type="text" class="form-control select2" required>
                            ...
                            <option value="only-tution-fees"
                              {{ $ft == 'edit' && $sd->covers == 'only-tution-fees' ? 'Selected' : '' }}>Only Tution
                              Fees
                            </option>
                          </select>
                          <span class="text-danger">
                      ...
                      <div class="col-md-2 col-sm-12">
                        <div class="form-group">
                          ...
                          <select name="provider_type_id" id="provider_type_id" type="text"
                        ...
                        <div class="form-group">
                          ...
                          <select name="provider" id="provider" type="text" class="form-control select2" required>
                            ...
                            @if ($ft == 'edit')
                              ...
                              @foreach ($prv as $prv)
                                <option value="{{ $prv->id }}"
                                  {{ $sd->provider_id == $prv->id ? 'Selected' : '' }}>
            ...
            <div class="col-lg-12 col-md-12 col-12">
              <div class="box">
                <form action="{{ $url }}" method="post" class="form" enctype="multipart/form-data">
                  @csrf
                  <div class="box-body">
                    <h4 class="box-title text-info"> Post Scholarship</h4>
                    <hr class="my-15">
                    <div class="row">
                      <div class="col-md-2 col-sm-12">
                        <div class="form-group">
                      ...
                      @foreach ($rows as $row)
                        <tr id="row{{ $row->id }}">
                          ...
                          <td>
                            ...
                            @if ($seg == '')
                              <a href="{{ url('admin/external-scholarship/update/' . $row->id) }}"
                                class="waves-effect waves-light btn btn-sm btn-outline btn-info">
                                <i class="fa fa-edit" aria-hidden="true"></i>
                              </a>
                            @else
                              <a href="{{ url('admin/external-scholarship/post/' . $row->id) }}"
                                class="waves-effect waves-light btn btn-sm btn-outline btn-info">
                                Post
                              </a>
                            @endif
  ...
  <script>
    ...
    function DeleteAjax(id) {
      ...
      if (cd == true) {
        $.ajax({
          url: "{{ url('admin/external-scholarship/delete') }}" + "/" + id,
          success: function(data) {
            if (data == '1') {
              $('#row' + id).remove();
              var h = 'Success';
