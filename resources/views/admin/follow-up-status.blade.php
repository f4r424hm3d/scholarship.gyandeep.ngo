...
@push('title')
  <title>Follow-UP Status - Gyandeep NGO</title>
@endpush
            ...
            <div class="d-inline-block align-items-center">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Follow-UP Status</li>
                </ol>
              </nav>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-4 col-sm-12">
                      <div class="form-group">
                        ...
                        <input name="followup_status" type="text" class="form-control"
          ...
          <div class="col-lg-12 col-md-12 col-12">
            <div class="box">
              <div class="box-header">
                <h4 class="box-title">Follow-UP Status List</h4>
              </div>
              <div class="box-body">
