...
@section('main-section')
            ...
            <div class="d-inline-block align-items-center">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Provider Faqs</li>
                </ol>
              </nav>
            </div>
          </div>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12">
                      <div class="form-group">
                        ...
                        <textarea row="4" name="question" id="question" class="form-control" required>{{ $ft == 'edit' ? $sd->question : old('question') }}</textarea>
                      ...
                      @foreach ($rows as $row)
                        <tr id="row{{ $row->id }}">
                          ...
                          <td>
                            ...
                            <a href="{{ url('admin/provider-faq/' . $pro->id . '/update/' . $row->id) }}"
  ...
  <script>
    ...
    function DeleteAjax(id) {
      ...
      if (cd == true) {
        $.ajax({
          url: "{{ url('admin/profaq/delete') }}" + "/" + id,
