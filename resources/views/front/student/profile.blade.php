            ...
            <div class="box_general_3">
              <div class="row">
                <div class="col-md-6 mb-2">
                  <i class="icon-user-1"></i> <strong>Gender :</strong>
                  {{ $student->gender }}
                </div>
                <div class="col-md-6 mb-2">
                  <i class="icon-calendar"></i> <strong>DOB :</strong> {{ $student->dob }}
                </div>
                <div class="col-md-6 mb-2">
                  <i class="icon-flag"></i> <strong>Nationality :</strong>
                  {{ $student->nationality }}
                </div>
                <div class="col-md-6 mb-2">
                  <i class="icon-location-outline"></i> <strong>Current location :</strong>
