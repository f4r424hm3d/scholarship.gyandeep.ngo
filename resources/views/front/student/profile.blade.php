                  ...
                  <div class="row">
                    ...
                    @else
                      <div class="pb-2">
                        ...
                        <div class="box_general_3">
                          <p class="text-danger"><strong>Note:</strong> All fields marked with <span
                          ...
                          <form action="{{ url('profile/update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                              ...
                              <div class="col-md-3 col-sm-12">
                                <label class="form-label " for="c_code">Country Code <span
                                    class="text-danger">*</span></label>
                                <input type="number" min="0" class="form-control" name="c_code"
                                  id="c_code" placeholder="Enter country code" value="{{ old('c_code') }}">
                                @error('c_code')
                                  <span class="text-danger">{{ $message }}</span>
                                @enderror
                              </div>
                              ...
                              <div class="col-md-3 col-sm-12">
                                <label class="form-label " for="dob">D.O.B <span
                                    class="text-danger">*</span></label>
                              ...
                              <div class="col-md-3 col-sm-12">
                                <label class="form-label " for="religion">Religion <span
                                    class="text-danger">*</span></label>
                            ...
                            <div class="row g-3">
                              ...
                              <div class="col-md-6 col-sm-12">
                                <label class="form-label" for="home_address">Address <span
                                    class="text-danger">*</span></label>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-3 col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="10th" placeholder="10th"
                                  value="10th" disabled />
                              </div>
                              <div class="col-md-3 col-sm-12 mb-3">
                              ...
                              <div class="col-md-3 col-sm-12 mb-3">
                                <label for="result_10" class="form-label">Result <span
                                    class="text-danger">*</span></label>
                              ...
                              <div class="col-md-3 col-sm-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="12th" placeholder="12th"
                                  value="12th" disabled />
                              </div>
                              <div class="col-md-3 col-sm-12 mb-3">
                              ...
                              <div class="col-md-3 col-sm-12 mb-3">
                                <label for="result_12" class="form-label">Result <span
                                    class="text-danger">*</span></label>
                              ...
                              <div class="col-md-3 col-sm-12 mb-3">
                                <label for="country_of_education" class="form-label">Grade</label>
                                <input type="text" class="form-control" id="NEET" placeholder="NEET"
                                  value="NEET" disabled />
                              </div>
                              <div class="col-md-3 col-sm-12 mb-3">
                                <label for="neet_passing_year" class="form-label">Passing Year</label>
                                <input type="year" class="form-control" id="neet_passing_year"
                                  name="neet_passing_year" placeholder="Enter Passing Year" max="{{ date('Y') }}"
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4 mb-3">
                                <label for="marksheet_10_copy" class="form-label">Upload 10th Marksheet <span
                                    class="text-danger">*</span></label>
                                <input type="file" class="form-control" id="marksheet_10_copy"
                                  name="marksheet_10_copy" value="{{ old('marksheet_10_copy') }}">
                              ...
                              <div class="col-md-4 mb-3">
                                <label for="marksheet_12_copy" class="form-label">Upload 12th Marksheet <span
                                    class="text-danger">*</span></label>
                                <input type="file" class="form-control" id="marksheet_12_copy"
                                  name="marksheet_12_copy" value="{{ old('marksheet_12_copy') }}">
                              ...
                              <div class="col-md-4 mb-3">
                                ...
                                <input type="file" class="form-control" id="neet_result_copy"
                                  name="neet_result_copy" value="{{ old('neet_result_copy') }}">
                              ...
                              <div class="col-md-4 col-sm-12 mb-3">
                                ...
                                <select class="form-select" id="scholarship" name="scholarship"
                                  ...
                                  @foreach ($scholarships as $row)
                                    <option value="{{ $row->id }}"
                                      {{ old('scholarship') == $row->id ? 'selected' : '' }}>
                                      {{ $row->name }}</option>
                                  @endforeach
                                </select>
                                @error('scholarship')
