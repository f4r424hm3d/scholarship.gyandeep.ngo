...
<hr>
      ...
      <div class="col-md-3 col-sm-12">
        ...
        <input type="text" class="form-control" name="interested_course_category" id="interested_course_category" placeholder="Interested Subject/Course" >
      </div>

      <div class="col-md-3 col-sm-12">
        <label class="form-label " for="interested_university">Interested University</label>
        <input type="text" class="form-control" name="interested_university" id="interested_university" placeholder="Interested University">
      </div>

      <div class="col-md-3 col-sm-12">
        <label class="form-label " for="highest_qualification">Highest Qualification</label>
        <input type="text" class="form-control" name="highest_qualification" id="highest_qualification" placeholder="Highest Qualification" >
      </div>

      <div class="col-md-3 col-sm-12">
        <label class="form-label " for="exam_taken">Exam Taken</label>
        <input type="text" class="form-control" name="exam_taken" id="exam_taken" placeholder="Exam Taken" >
      </div>

      <div class="col-md-3 col-sm-12">
        <label class="form-label " for="preferred_destination">Preferred Destination</label>
        <input type="text" class="form-control" name="preferred_destination" id="preferred_destination" placeholder="Preferred Destination" >
      </div>
    </div>
...
<div class="row g-3">
  ...
  <div class="col-md-3 col-sm-12">
    ...
    <input type="number" min="0" class="form-control" name="c_code" id="c_code" placeholder="Enter country code">
  </div>
  ...
  <div class="col-md-3 col-sm-12">
    ...
    <input type="text" class="form-control" name="father" id="father" placeholder="Enter Father Name">
  </div>

  <div class="col-md-3 col-sm-12">
    <label class="form-label " for="father_mobile">Father Mobile</label>
    <input type="text" class="form-control" name="father_mobile" id="father_mobile" placeholder="Enter Father Mobile">
  </div>

  <div class="col-md-3 col-sm-12">
    <label class="form-label " for="mother">Mother Name</label>
    <input type="text" class="form-control" name="mother" id="mother" placeholder="Enter Mother Name">
  </div>

  <div class="col-md-3 col-sm-12">
    <label class="form-label " for="mother_mobile">Mother Mobile</label>
    <input type="text" class="form-control" name="mother_mobile" id="mother_mobile" placeholder="Enter Mother Mobile">
  </div>
...
<div class="col-md-3 col-sm-12">
  ...
  <input type="text" class="form-control" name="occupation" id="occupation" placeholder="Enter Personal Occupation">
</div>
  ...
  <div class="col-md-3 col-sm-12">
    ...
    <input type="text" class="form-control" name="first_language" id="first_language" placeholder="Enter First Language">
  </div>
  ...
  <div class="col-md-3 col-sm-12">
    ...
    <input type="date" class="form-control" name="passport_expiry" id="passport_expiry" placeholder="Enter Passport Expiry date">
  </div>
...
<hr>
  ...
  <div class="col-md-6 col-sm-12">
    ...
    <input type="text" class="form-control" name="home_address" id="home_address" placeholder="Enter address">
  </div>
...
<div class="col-md-3 col-sm-12">
  ...
  <div class="col-md-3 col-sm-12">
    ...
    <input type="text" class="form-control" name="zipcode" id="zipcode" placeholder="Enter Postal/Zipcode">
  </div>

  <div class="col-md-3 col-sm-12">
    <label class="form-label" for="home_contact_number">Home Contact Number</label>
    <input type="number" class="form-control" name="home_contact_number" id="home_contact_number" placeholder="Enter home contact number">
  </div>
</div>
...
<hr>
   ...
   <div class="col-md-3 col-sm-12 mb-3">
    ...
    <select class="form-select" id="country_of_education" name="country_of_education" aria-label="Country of Education">
  ...
  <div class="col-md-3 col-sm-12 mb-3">
    ...
    <select class="form-select" id="highest_level_of_education" name="highest_level_of_education" aria-label="Highest Level of Education">
      <option selected>Select</option>
  ...
  <div class="col-md-3 col-sm-12 mb-3">
    ...
    <input type="text" class="form-control" id="grade_average" name="grade_average" placeholder="Enter Grade Average" />
  </div>
</div>
<!-- Test Score start 1 -->
...
<div class="row">
  ...
  <div class="col-md-4 mb-3">
    ...
    <input type="file" onchange="validate(this.value)" class="form-control" id="files" name="files" required>
  ...
  <div class="col-md-4 mb-3 d-flex align-items-end">
    <div>
      <button onclick="wait()" id="sbtBtnDu" name="uploadDoc" type="submit" class="btn btn-primary me-2">
...
<div class="row mb-3">
  ...
  <div class="col-sm-12 col-md-6 text-md-end mt-3 mt-md-0">
    ...
    <input type="search" id="searchInput" class="form-control form-control-sm d-inline-block w-auto ms-2" placeholder="Search..." aria-controls="datatables-basic">
  </div>
