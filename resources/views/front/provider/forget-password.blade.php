      ...
      <div class="container margin_60_35">
        <div id="login">
          ...
          <div class="box_form">
            ...
            <form method="post" action="{{ url('provider/forget-password') }}" enctype="multipart/form-data">
              @csrf
              ...
              <a href="{{ url('provider/login') }}"><small>Already member ? Login </small></a>
              <a href="{{ url('provider/signup') }}" class="float-end"><small>Create a new account</small></a>
