...
@push('title')
  <title>Edit Profile : Provider - Gyandeep NGO</title>
@endpush
        ...
        <div class="col-xl-7 col-lg-7">
          ...
          <div class="pb-2">
            ...
            <div class="box_general_3">
              <form action="{{ url('provider/profile/change-password') }}" method="post">
                @csrf
                ...
                <input type="submit" class="btn_1 medium" value="Save"> &nbsp; &nbsp;<a
                  href="{{ url('provider/profile') }}" class="medium">Cancel</a>
              </form>
            </div>
          </div>
        </div>
