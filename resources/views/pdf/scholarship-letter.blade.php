...
<body style="width: 100%;">
  <main class="content">
    <div class="container-fluid p-0">
      <div>
        <header>
          <div class="logo"><img src="{{ public_path($letter->company->logo_path) }}" /></div>
          <div class="right-links">
            <div class="mobile"><img src="{{ public_path('icon/mobile.jpg') }}" />
              {{ $letter->company->mobile }}</div>
            <div class="email"><img src="{{ public_path('icon/email.jpg') }}" />
              {{ $letter->company->email }}</div>
            <div class="website"><img src="{{ public_path('icon/website.jpg') }}" />
          ...
          @if ($letter->signature == 1 || $letter->stamp == 1)
            <div class="sign-stamp">
              @if ($letter->signature == 1 && $letter->company->signature_path != null)
                <div class="sign"><img src="{{ public_path($letter->company->signature_path) }}" /></div>
              @endif
              @if ($letter->stamp == 1 && $letter->company->stamp_path != null)
                <div class="stamp"><img src="{{ public_path($letter->company->stamp_path) }}" /></div>
              @endif
            </div>
            <br><br>
          @endif
        ...
        <footer>
          ...
          <div class="footer-links">
            <img src="{{ public_path('icon/marker.jpg') }}" />
