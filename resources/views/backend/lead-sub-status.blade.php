...
@push('title')
  <title>Lead Sub Status - Gyandeep NGO</title>
@endpush
            ...
            <div class="d-inline-block align-items-center">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Lead Sub Status</li>
                </ol>
              </nav>
            </div>
          </div>
          ...
          <div class="col-lg-12 col-md-12 col-12">
            <div class="box">
              <div class="box-header">
                <h4 class="box-title">Lead Sub Status List</h4>
              </div>
              <div class="box-body">
