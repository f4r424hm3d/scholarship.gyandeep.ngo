            ...
            <div class="d-inline-block align-items-center">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Create Exams</li>
                </ol>
              </nav>
            </div>
          </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                      <div class="form-group">
                        ...
                        <input name="start_time" type="datetime-local" class="form-control" placeholder="Start Time"
                          value="{{ $ft == 'edit' ? $sd->start_time : old('start_time') }}">
                        <span class="text-danger">
                          @error('start_time')
                            {{ $message }}
                          @enderror
                    ...
                    <div class="col-md-3 col-sm-12">
                      <div class="form-group">
                        ...
                        <input name="end_time" type="datetime-local" class="form-control" placeholder="End Time"
                          value="{{ $ft == 'edit' ? $sd->end_time : old('end_time') }}">
                        <span class="text-danger">
                          @error('end_time')
                            {{ $message }}
                          @enderror
                    ...
                    <div class="col-md-3 col-sm-12">
                      <div class="form-group">
                        <label>Time Duration <b>(In minutes)</b></label>
                        <input name="duration" type="number" class="form-control"
                          placeholder="Exam time duration in minutes"
                          value="{{ $ft == 'edit' ? $sd->duration : old('duration') }}">
                        <span class="text-danger">
                          @error('duration')
                            {{ $message }}
                          @enderror
          ...
          <div class="col-lg-12 col-md-12 col-12">
            <div class="box">
              <div class="box-header">
                <h4 class="box-title">Create Exams List</h4>
              </div>
              <div class="box-body">
                      ...
                      @foreach ($rows as $row)
                        <tr id="row{{ $row->id }}">
                          ...
                          <td>
                            ...
                            <a title="Edit" href="{{ url('admin/exams/update/' . $row->id) }}"
                              class="waves-effect waves-light btn btn-xs btn-info">
                              <i class="fa fa-edit" aria-hidden="true"></i>
                            </a>
                            <a title="Add Instruction" target="_blank"
                              href="{{ url('admin/exam-instruction/' . $row->id) }}"
