...
@push('title')
  <title>Create Subjects - Gyandeep NGO</title>
@endpush
@section('main-section')
                  ...
                  <div class="row">
                    <div class="col-md-3 col-sm-12">
                      <div class="form-group">
                        ...
                        <input name="subject" type="text" class="form-control" placeholder="Enter Subject Name"
                          value="{{ $ft == 'edit' ? $sd->subject : old('subject') }}">
          ...
          <div class="col-lg-12 col-md-12 col-12">
            <div class="box">
              <div class="box-header">
                <h4 class="box-title">Create Subjects List</h4>
              </div>
              <div class="box-body">
                      ...
                      @foreach ($rows as $row)
                        <tr id="row{{ $row->id }}">
                          ...
                          <td>
                            ...
                            <a href="{{ url('admin/subjects/update/' . $row->id) }}"
  ...
  <script>
    ...
    function DeleteAjax(id) {
      ...
      if (cd == true) {
        $.ajax({
          url: "{{ url('admin/subjects/delete') }}" + "/" + id,
          success: function(data) {
            if (data == '1') {
              $('#row' + id).remove();
              var h = 'Success';
