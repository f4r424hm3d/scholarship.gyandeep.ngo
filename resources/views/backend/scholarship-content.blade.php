...
@section('main-section')
            ...
            <div class="d-inline-block align-items-center">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{ url('/admin/scholarship') }}">Scholarship</a></li>
          ...
          <div class="col-lg-12 col-md-12 col-12">
            <div class="box">
              <form action="{{ $url }}" method="post" class="form" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="page_name" value="scholarship">
                <div class="box-body">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <textarea class="form-control mb-2 mr-sm-2" id="title" name="title" placeholder="Enter title">{{ $ft == 'edit' ? $sd->title : old('title') }}</textarea>
                    </div>
                    <div class="form-group col-md-12">
                      ...
                      @foreach ($rows as $row)
                        <tr id="row{{ $row->id }}">
                          ...
                          <td>
                            ...
                            <a href="{{ url('admin/scholarship/content/update/' . $row->id) }}"
  ...
  <script>
    ...
    function DeleteAjax(id) {
      ...
      if (cd == true) {
        $.ajax({
          url: "{{ url('admin/scholarship/content/delete') }}" + "/" + id,
